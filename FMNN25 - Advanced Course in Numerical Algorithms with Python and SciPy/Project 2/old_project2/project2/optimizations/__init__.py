...
class NewtonOptimization(abc.ABC):
    def __init__(
        self,
        fun,
        x0,
...
class ClassicalNewtonOptimization(NewtonOptimization):
    def step(self):
        current_step, _ = self.classical_newton_step()
        return current_step


class ExactLineSearchNewtonOptimization(NewtonOptimization):
    def step(self):
        current_step, _ = self.classical_newton_step()
...
class PowellWolfeLineSearchNewtonOptimization(NewtonOptimization):
    def step(self):
...
class QuasiNewtonOptimization(NewtonOptimization):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._hessian_or_inv = self.hessian(self._x)
