		...
		public RefGUI(double amp, double h) {
			...
			paramsAmpField.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					boolean ok = true;
					Double doubleObject = Double.valueOf(0.0);
					try {
						doubleObject = Double.valueOf(tempString);
					} catch (Exception x) {
						ok = false;
					}
					double tempValue;
					...
					if (tempValue < 0.0) {
						Double d1 = Double.valueOf(amplitude);
			...
			paramsPeriodField.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (tempValue < 0.0) {
						Double d1 = Double.valueOf(period);
